...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sl', '<cmd>Telescope persisted<cr>', { desc = '[S]earch [L]atest Sessions' })
      ...
      vim.keymap.set('n', '<leader>+', '<leader>/', { desc = '[/] Fuzzily search in current buffer', remap = true })
